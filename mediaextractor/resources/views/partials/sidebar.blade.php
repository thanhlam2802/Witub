            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-layouts" class="py-2 space-y-2 {{ $group === 'layout' ? '' : 'hidden' }}">

                            <li>
                                <a href="{{ route('categories.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 {{ $page_slug === 'categories' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Categories
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('category-types.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11  group hover:bg-gray-100 {{ $page_slug === 'category-types' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    All Types
                                </a>
                            </li>
                            ...
                            @foreach ($categoryTypes as $type)
                                <li>
                                    <a href="{{ route('categories.index', ['type' => $type->id]) }}"
                                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11  group hover:bg-gray-100 {{ request('type') == $type->id ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                        {{ $type->name }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <li>
                        ...
                        <ul id="dropdown-crud" class="space-y-2 py-2 {{ $group === 'crud' ? '' : 'hidden' }}">
                            <li>
                                <a href="{{ route('posts.index') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
       dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug === 'posts' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Posts
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('users.index') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
       dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug === 'users' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Users
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('locales.index') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug === 'locales' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Languages
                                </a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pages" class="space-y-2 py-2 {{ $group === 'page' ? '' : 'hidden' }}">
                            <li>
                                <a href="{{ route('admin.seo_tools.index') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
       dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug === 'seo-tools' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Robots & Sitemap
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-playground"
                            class="space-y-2 py-2 {{ $group === 'playground' ? '' : 'hidden' }}">
                            <li>
                                <a href=""
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug === 'stacked' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">Stacked</a>
                            </li>
