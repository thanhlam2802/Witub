        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="" class="flex ml-2 md:mr-24">
                    ...
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Thewinhouse</span>
                </a>
            ...
            <div class="flex items-center">
                ...
                @else
                    <a href="{{ route('auth.login.view') }}"
                        class="text-sm text-gray-700 dark:text-gray-400 hover:underline">Log in</a>
                @endauth
            </div>
        </div>
</nav>
